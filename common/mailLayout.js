        ...
        <tr>
            <td align="center" valign="top">
                <table width="600" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="border: 1px solid #f1f2f5">
                    <tbody>
                        <tr>
                            <td colspan="3" height="65" bgcolor="#ffffff"
                                style="border-bottom: 1px solid #eeeeee; padding-left: 16px" align="left">
                                <img src=${image.logo} height="60" style="display: block; width: 140px; height: 35px"
                                            ...
                                            <td colspan="3">
                                                ...
                                                <div
                                                    ...
                                                    <div style="
                                                        ...
                                                        <img src=${image.email} width=100% // height=557px
                                                            tabindex="0" />
                                                    </div>
                                                </div>
                                                <table width="100%" style="width: 100% !important">
                                                    <tbody>
                                                        <tr>
                                                            <td align="center">
                                                                <a href="http://localhost:3000/register/confirm?emailVerificationToken=${emailVerificationToken}"
                                                                    style="
                                                ...
                                                <p style="
                                                    ...
                                                    <br />
                                                    <br />
                                                    <b>This link will expire after 2 hours. To request another
                                                        verification<br />
                                                        link, please
                                                        <a href="http://localhost:3000/login"
                                                            style="text-decoration: none; color: #007cad"
                                                            target="_blank"
                                                            data-saferedirecturl="http://localhost:3000/login">log
                                                            in</a>
...
<div>
    <div style="
        ...
        <div style="width= " 500px"; padding: 15px; display="flex" ; justify-content="center" ; flex-direction="column"">
                  <div
                      style=" margin-bottom: 15px; width: 400px; height: 70px; padding: 5px 0; border-bottom: 3px solid
            rgba(250, 136, 5, 0.696); padding-right: 30px; "
                  >
                      <img
                          style=" height: 100%" src=${urlLogo} />
    </div>
